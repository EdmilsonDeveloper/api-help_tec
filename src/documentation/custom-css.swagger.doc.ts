...
.topbar-wrapper img {content:url(\'https://i.imgur.com/wnRbTks.png\'); text-align: center ;width:400px; height:auto;}
.swagger-ui .topbar { text-align: center; }
.topbar-wrapper a { text-align: center;}
.swagger-ui .topbar a {display: inline}
.swagger-ui .topbar .topbar-wrapper {display: inline}
.renderedMarkdown p {color: orange}
.swagger-ui .prop-type {color: #00ff00}
`;
